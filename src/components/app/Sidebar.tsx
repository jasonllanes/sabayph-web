import { Compass, Users, Map, User, LogOut } from 'lucide-react';
...
export default function Sidebar({ activeTab, onTabChange, theme, user, onLogout }: SidebarProps) {
  return (
    <div
      style={{
    ...
    >
      <div style={{ padding: '24px 20px 20px', borderBottom: `1px solid ${theme.border}`, display: 'flex', alignItems: 'center', gap: 10 }}>
        <img
          ...
          alt="SabayPH"
          style={{ width: 40, height: 40, borderRadius: 10, border: `2px solid ${theme.primary}`, objectFit: 'cover' }}
        />
        <div>
          ...
          <p className="font-pixel" style={{ fontSize: 10, color: theme.textMuted, margin: 0, letterSpacing: 1 }}>
            WHEREVER YOU GO
          </p>
        </div>
      </div>
          ...
          return (
            <button
              ...
              style={{
                ...
                border: active ? `1.5px solid ${theme.primary}30` : '1.5px solid transparent',
            ...
            >
              <Icon
                ...
                style={{ color: active ? theme.primary : theme.textMuted, flexShrink: 0 }}
              />
              <span style={{ fontSize: 14, fontWeight: active ? 700 : 500, color: active ? theme.primary : theme.text }}>
                {label}
              </span>
              {id === 'rooms' && (
                <span style={{ marginLeft: 'auto', fontSize: 10, fontWeight: 700, background: theme.primary, color: theme.surface, padding: '2px 7px', borderRadius: 10 }}>
                  0
                </span>
              )}
            </button>
      ...
      <div style={{ padding: '12px 20px', borderTop: `1px solid ${theme.border}`, borderBottom: `1px solid ${theme.border}` }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <p className="font-pixel" style={{ fontSize: 11, color: theme.accent, margin: 0, letterSpacing: 1 }}>
            TARA, SABAY TAYO!
          </p>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div
            style={{
              ...
              fontFamily: '"Bricolage Grotesque", serif', fontWeight: 800, fontSize: 15,
              flexShrink: 0,
            }}
          >
